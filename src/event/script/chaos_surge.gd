...
func _init():
	...
	var option1 = CustomEvent.Option.new("Leave, before this place can affect you further (Choose a card from your deck to Transform)", null, func():
	...
	var option3 = CustomEvent.Option.new("Stay a bit longer and search for something useful (Transform a random card in your Deck. Choose a Blessing)", null, func():
	...
	var option2 = CustomEvent.Option.new("Give in to the chaos (Transform all cards in your deck into random cards)", null, func(): 
